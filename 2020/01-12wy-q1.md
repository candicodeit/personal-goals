...
- [x] Read 8 books per 12 weeks (at least 2 a month)
    ...
    - [] [The Prosperous Coach](https://www.goodreads.com/book/show/18934115-the-prosperous-coach)
...
- [ ] send 20 request emails
- [ ] figure out best instruction to add a new hospital
- [ ] update any documentation for Ready Bag
- [ ] follow-up with Ready Bag coordinator about new dashboard
- [ ] test GiveSmart ticketing
...
- [ ] write future self journal entry every day (0/7)
    ...
    - [ ] sat
    - [ ] sun
- [ ] sleep 49 hrs (7 hrs a night) (8/49)
    - [x] mon 8:18
    - [ ] tue
    - [ ] wed
    - [ ] thu
