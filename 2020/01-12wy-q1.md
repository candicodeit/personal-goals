...
- ~~Write a blog post~~ (found that coaching has been more of my passion and focus for the past month)
    - [x] pick a topic
    - [x] draft a post
    - refine post and gain feedback
    - publish blog post
- Coach 3 people (started mid-Feb)
    - [ ] obtain 3 coaching relationships (currently 2)
        - [x] E
        - [x] S
        - [ ] U
...
### Reading Goals
- [x] Read 8 books per 12 weeks (at least 2 a month) 12 books
    ...
    - [x] [Coaching for Performance](https://www.goodreads.com/book/show/49643945-coaching-for-performance)
    - [x] [Be Our Guest](https://www.goodreads.com/book/show/25967971-be-our-guest)


### Social Gathering Checklist - 6/10
- [x] Lunch date - RD
- [x] Coworking - SW / RSF / SW + SD
- [x] Night out with friends MB
- [x] Breakfast meetup TL
- [ ] Movie Night
- [x] Serving Others RSF - Packing Party
- [ ] Alone for a day
- [ ] Day outdoors
- [ ] 24 hours no social media
- [x] Date night - The Butcher's Son dinner
...
### Week 5 | Feb 3 - 9
- [x] complete Project Management Approaches section | GoSkills - 25%
...
- [ ] send 20 request emails
- [ ] figure out best instruction to add a new hospital
- [x] support ticket launch 
- [ ] schedule operations meeting for Feb
- [ ] draft a blog post

- [x] read 1hr a day (7/7) - 100%
    - [x] mon 
    - [x] tue
    - [x] wed
    - [x] thu
    ...
    - [x] sat
    - [x] sun
- [x] write future self journal entry every day (3/7) - 42%
    - [ ] mon 
    - [x] tue
    - [ ] wed
    - [ ] thu
...
- [ ] sleep 49 hrs (48:15/49) 98%
  ...
  _Reflection_   
- what success or positive results have you seen so far?
    - I've been really good about figuring out best way to spend my time. I can identify what's busy work and what is worth working towards a bigger goal or opportunity. I've finished a lot of things that make a good impact. It's hard to say 'no' to opportunities but sometimes you just have to figure out your goals and values. 
- what pitfalls did you encounter?
    - I've had to juggle what opportunities I wanted to pursue. I'm glad I can figure out what I need to do by feel. 
- what would you do differently for the next 12 weeks?
    - Continue to focus on what goes towards my goals and pursuing what matches my values. 
- do you feel any different about your goals than you did week 1?
    - Blogging is not important to me. I really want to focus on coaching. I like building relationships and helping people grow. 
- other reflections
    - I love finding people and companies that focus on non-profits and volunteering. Volunteering not in the sense of labor but sharing skillsets that they don't typically have access to. 
...
- habits 
    - read 1 hr a day - 100%
    - write future self journal entry every day - 42%
    - sleep 7 hrs a day / 49 hrs total - 98%
...
- [ ] send 20 request emails
- [x] demo marketing emails/text for GiveSmart
- [x] schedule operations meeting
- [ ] figure out file sharing and folder duplication
- [x] demo Amazon "Buy Again"
...
- [ ] sleep 49 hrs (0/49)
  ...
  _Reflection_   
I have not been doing my planning as I should for the past few weeks. I was involved in a paid interview process that spanned about 3 weeks, mostly because I got sick in the middle. I learned a lot within the process even though I didn't get the job. I made sure to learn from my previous experience to go into any sort of interview with good healthy. Whenever I'm still recover from a cold, it's hard to really focus. I learned a lot about asking for strength vs asking for something specific. Who knows the reason behind certain decisions until sometimes it reveals itself later. I value the people I have surrounded myself with who have supported me in my journey. Because of them, I feel like I was able to bounce back from rejection and focus on how I can move forward instead of dwelling on the past. I realize that is ok to feel sad. Sometimes we just need some time to heal. I do feel the stress when I don't plan my day well or if I don't get to escape in my books. I hope to recover for the rest of the month and read as much as I can. 


### Week 11 | Mar 16 - 22
- [ ] write perks/lessons from a remote-first company
- [ ] review Agile Practitioner

- [ ] identify back-up plan for NFTF
- [ ] send 40 request emails
...
_Quarterly Reflections_
- what success or positive results have you seen so far?
    - I feel like the beginning of the quarter, I was fairly successful since it was the start of the new year. I was minimizing my focus so I was able to complete more things. 
- what pitfalls did you encounter?
    - Once I started a paid interview process, my routine went off course. Though it seemed appropriate to adjust my priorities for this specific task, I felt pretty frazzled by not having a routine. Afterwards, the Coronavirus really threw things for a twist. It's taking a bit to adjust to the new "normal". 
- what would you do differently for the next 12 weeks?
    - Continuing to focus on fewer things for the next quarter. Allowing myself to incorporate more self-care during stressful times. 
- do you feel any different about your goals than you did week 1?
    - I feel like I might need to really reflect on my career goals. I need to figure out which exact path I'd like to take and reason why I would want to go that route. A lot of things factor in. 
- other reflections
    - I think the combination of my Github and Monk Manual have done fairly well in the beginning. Due to unexpected circumstances, I haven't fully been able to keep up with my goals via Github. I have partially been able to use my Monk Manual to keep up with my daily planning. 