...
## Goals
- Obtain Lean Six Sigma Yellow Belt Certification
    - complete GoSkills course (breakdown tbd)
    - take exam
...
### Reading Goals
- [ ] Read 8 books per 12 weeks (at least 2 a month)
    ...
    - [ ] [Queen of Shadows - 75%](https://www.goodreads.com/book/show/18006496-queen-of-shadows)
    - [x] [Anxious for Nothing](https://www.goodreads.com/book/show/18006496-queen-of-shadows)
    - [ ] [Coactive Coaching - 22%](https://www.goodreads.com/book/show/36547100-co-active-coaching)
...
- [ ] read 1 hr a day (3/7)
    ...
    - [x] sat
    - [ ] sun
- [ ] write future self journal entry every day (2/7)
    - [ ] mon 
    - [x] tue
    - [x] wed
    - [ ] thu
...
- [ ] verify count for Ready Bag totals
- [ ] lock any formulas on Ready Bag spreadsheet
- [ ] finalize Ready Bag spreadsheet and remove test data
...
### Week 7 | Feb 17 - 23
- [ ] complete Managing the Sprint section | GoSkills
- [ ] send 20 request emails
- [ ] refine blog post
